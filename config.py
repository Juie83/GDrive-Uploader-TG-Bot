...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5587311521:AAFcGar2idhzJr3obs2hgrFXUmWzexYaqtI' # Get it from https://t.me/BotFather
    APP_ID = '15073707' # Get it from my.telegram.org/apps
    API_HASH = '0f0ff9b47cbd315fb9672aef08eee93c' # Get it from my.telegram.org/apps
